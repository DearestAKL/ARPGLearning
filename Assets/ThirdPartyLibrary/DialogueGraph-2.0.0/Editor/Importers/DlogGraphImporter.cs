        ...
        public override void OnImportAsset(AssetImportContext ctx) {
            try {
                ...
                foreach (var node in dlogObject.DlogGraph.Nodes) {
                    ...
                    switch (node.Type) {
                        case "DialogueGraph.OptionNode":
                            runtimeNode.Type = NodeType.OPTION;
                            break;
                        case "DialogueGraph.DialogueNode":
                            runtimeNode.Type = NodeType.DIALOGUE;
                            break;
                    ...
                    // Get lines
                    if (runtimeNode.Type == NodeType.OPTION) {
                    ...
                    } else if (runtimeNode.Type == NodeType.DIALOGUE) {
                        runtimeNode.Lines = new List<ConversationLine>();
                ...
                DlogSerializer.Serialize(runtimeObject);
