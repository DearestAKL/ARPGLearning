...
namespace DialogueGraph {
    ...
    [Title("Option")]
    public class OptionNode : AbstractNode {
        ...
        public override void InitializeNode(EdgeConnectorListener edgeConnectorListener) {
            ...
            Initialize("Option", EditorView.DefaultNodePosition);

            lineLabel = new Label {name = "lineTitle", text = "Lines"};
            outputContainer.Add(lineLabel);

            var button = new Button(() => AddConversationPort(true)) {text = "Create Option Line"};
