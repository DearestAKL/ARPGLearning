...
//            Debug.Log("AWAKE !!");
            ...
            smallTextStyle.normal.textColor = EditorGUIUtility.isProSkin ? Color.white : Color.black;

//            nodeTextStyle = new GUIStyle(EditorStyles.label);

            nodeCapsuleGray = (GUIStyle)"helpbox";
            nodeCapsuleGray.normal.textColor = EditorGUIUtility.isProSkin ? Color.white : Color.black;
