...
namespace TreeDesigner
{
    ...
    public abstract partial class CompositeNode : BaseNode
    {
        ...
        public GfBtCompositeMessage GetCompositeMessage()
        {
            var message = new GfBtCompositeMessage() { Children = { } };
            for (int i = 0; i < Children.Count; i++)
            {
                message.Children.Add(m_Owner.GetSerializerNodeIndex(Children[i]));
            }
            return message;
        }
    }
