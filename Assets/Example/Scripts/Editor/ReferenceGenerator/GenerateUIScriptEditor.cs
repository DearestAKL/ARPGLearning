...
public class GenerateUIScriptEditor
{
    ...
    {
        var templateUIPanelFile = "Assets/Example/GameArt/TemplateConfigs/UIPanelTemplate.txt";
        var templateUIItemFile = "Assets/Example/GameArt/TemplateConfigs/UIItemTemplate.txt";

        var outputPath = "Assets/Example/Scripts/Runtime/UI/_GenerateScript/";
        ...
        switch (uiCtrl.viewType)
        {
            case ViewType.Panel:
                tarTemplateFilePath = templateUIPanelFile;
                linealName = "UIPanel";
                break;
            case ViewType.Item:
                tarTemplateFilePath = templateUIItemFile;
                linealName = "UIItem";
                break;
            default:
                return;
        ...
        classStr = classStr.Replace("__NAME_SPACE__", "GameMain.Runtime");
