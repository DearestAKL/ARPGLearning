...
namespace TreeDesigner
{
    public partial class BaseTree : ScriptableObject
    {
        ...
        [NonSerialized]public List<BaseNode> SerializerTemporaryNodes;
        [NonSerialized]public List<BaseExposedProperty> SerializerTemporaryProperties;
        ...
        public int GetSerializerNodeIndex(BaseNode baseNode)
        {
            if (SerializerTemporaryNodes == null)
            {
                Debug.LogError("SerializerTemporaryNodes is null");
                return 0;
            }
            return SerializerTemporaryNodes.IndexOf(baseNode);
        }
        
        public int GetSerializerPropertiesIndex(BaseExposedProperty property)
        {
            if (SerializerTemporaryProperties == null)
            {
                Debug.LogError("SerializerTemporaryProperties is null");
                return 0;
            }
            return SerializerTemporaryProperties.IndexOf(property);
        }
    }
