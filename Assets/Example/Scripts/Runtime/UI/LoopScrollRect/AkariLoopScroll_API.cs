...
namespace GameMain.Runtime
{
    ...
    public partial class AkariLoopScroll<TData, TItemRenderer>
    {
        ...
        {
            return _onClickItemHashSet.Contains(GetItemIndex(item));
        }
        ...
        {
            return _onClickItemQueue.ToList();
        }
